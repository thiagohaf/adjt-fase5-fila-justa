...
/**
 * Ponto de entrada do app CDK do ConfirmaSus (story 1.1).
 *
...
public final class InfraApp {
    ...
    public static void main(final String[] args) {
        ...
        new ConfirmaSusStack(app, "ConfirmaSusStack", StackProps.builder()
                .env(env)
                .description("ConfirmaSus -- Story 1.1: VPC, ECS Fargate, Postgres 18 containerizado, "
