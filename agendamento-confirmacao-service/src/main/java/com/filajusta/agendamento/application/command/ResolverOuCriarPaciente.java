 ...
 * do comando chamador (ex.: {@code RegistrarAgendamento}) -- evita que dois
 * registros simultaneos para o mesmo CPF criem dois Pacientes (constraint
 * {@code UNIQUE(cpf)} como rede de seguranca).
 *
 ...
 * bem-sucedida reutilizando o mesmo {@code pacienteId} (Boundaries da spec
 * 1.1: "CPF ja visto sempre reutiliza o mesmo Paciente").
 */
