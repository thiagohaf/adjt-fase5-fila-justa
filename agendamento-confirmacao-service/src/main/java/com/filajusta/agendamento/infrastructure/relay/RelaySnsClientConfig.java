 ...
 * {@code filajusta.agendamento.outbox-relay.endpoint-override} fica vazio --
...
class RelaySnsClientConfig {
    ...
    @Bean
    SnsClient snsClient(@Value("${filajusta.agendamento.outbox-relay.endpoint-override:}") String endpointOverride,
                         @Value("${filajusta.agendamento.outbox-relay.region:}") String region) {
