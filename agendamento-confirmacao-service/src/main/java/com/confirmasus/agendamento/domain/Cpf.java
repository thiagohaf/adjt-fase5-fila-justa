 ...
 *
 * <p>Boundaries da spec 1.1: "CPF em texto claro nunca sai de
 * agendamento-confirmacao-service" -- este tipo nao e serializado em nenhuma
 * resposta ou payload de evento (ver {@code infrastructure/web}, que
 * referencia so {@code pacienteId}).
 */
