 ...
 *
 * <p><b>Contrato transacional</b> (mesmo achado do code review do molde):
 ...
 * vira inutil.
 *
 * <p>O unico produtor de {@link #salvar(EventoOutbox)} nesta fase e
 * {@code AbrirJanelaDeConfirmacao} (poller que abre a Janela de Confirmacao,
 * AD-3/AD-4).
 */
