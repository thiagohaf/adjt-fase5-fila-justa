 ...
 * application.command} muta estado: {@link com.confirmasus.agendamento.application.command.ResolverOuCriarPaciente}
 * (FR-2, idempotente por CPF, reaproveitado do servico anterior deste
 * dominio, renomeado nesta story)
 * e {@link com.confirmasus.agendamento.application.command.RegistrarAgendamento}
 ...
 */
package com.confirmasus.agendamento.application;
