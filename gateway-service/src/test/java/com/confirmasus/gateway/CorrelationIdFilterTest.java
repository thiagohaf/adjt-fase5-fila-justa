...
import com.confirmasus.gateway.infrastructure.web.CorrelationIdFilter;
 ...
 * {@link com.confirmasus.gateway.infrastructure.security.JwtAuthenticationFilter}.
 *
...
class CorrelationIdFilterTest {
    ...
    static void routeToStub(DynamicPropertyRegistry registry) {
        registry.add("confirmasus.jwt.secret", () -> JWT_TEST_SECRET);
