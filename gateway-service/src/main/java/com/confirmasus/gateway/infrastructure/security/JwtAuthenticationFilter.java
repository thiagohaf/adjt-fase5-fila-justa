package com.confirmasus.gateway.infrastructure.security;
...
public class JwtAuthenticationFilter implements GlobalFilter, Ordered {
    ...
    JwtAuthenticationFilter(@Value("${confirmasus.jwt.secret}") String secret) {
        if (secret == null || secret.getBytes(StandardCharsets.UTF_8).length < HS256_MIN_SECRET_BYTES) {
            ...
            throw new IllegalArgumentException(
                    "confirmasus.jwt.secret deve ter pelo menos " + HS256_MIN_SECRET_BYTES
    ...
    public int getOrder() {
        ...
        // (Integer.MIN_VALUE) -- o
        // com.confirmasus.gateway.infrastructure.web.CorrelationIdFilter roda
