...
import com.confirmasus.triagem.domain.TriagemDomainException;
...
public class TriagemExceptionHandler {
  private static final URI TRIAGEM_ERROR_TYPE = URI.create("https://confirmasus.local/triagem/error");
