...
- Valores calibráveis (`confirmasus.aging.k`, `confirmasus.aging.teto`, `confirmasus.liberacao.duracao.*` por tipo de Recurso) centralizados em `application.yml` do serviço — fonte única, nunca espalhados no código.
