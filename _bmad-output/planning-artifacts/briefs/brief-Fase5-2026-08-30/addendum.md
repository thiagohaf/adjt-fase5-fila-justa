...
- **Padrões de mercado:** seguir práticas correntes para microsserviços Java em produção (não deve ser tratado como um projeto de brinquedo, mesmo sendo acadêmico) — ex.: contratos versionados, observabilidade mínima, segurança de segredos fora do código, testes automatizados com cobertura mínima definida na arquitetura.
