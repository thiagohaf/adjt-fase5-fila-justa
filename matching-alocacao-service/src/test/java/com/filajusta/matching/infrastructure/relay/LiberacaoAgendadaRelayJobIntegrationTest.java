...
class LiberacaoAgendadaRelayJobIntegrationTest {
    ...
    static void relayProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("filajusta.matching.liberacao-agendada-relay.endpoint-override",
                () -> localstack.getEndpoint().toString());
        registry.add("filajusta.matching.liberacao-agendada-relay.region", localstack::getRegion);
        registry.add("filajusta.matching.liberacao-agendada-relay.queue-url", () -> queueUrl);
        registry.add("filajusta.matching.liberacao-agendada-relay.poll-interval-ms", () -> "300");
