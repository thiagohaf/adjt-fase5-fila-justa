...
class LiberacaoAgendadaSqsConsumerJobIntegrationTest {
    ...
    static void consumerProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("filajusta.matching.liberacao-agendada-consumer.enabled", () -> "true");
        registry.add("filajusta.matching.liberacao-agendada-consumer.endpoint-override",
                () -> localstack.getEndpoint().toString());
        registry.add("filajusta.matching.liberacao-agendada-consumer.region", localstack::getRegion);
        registry.add("filajusta.matching.liberacao-agendada-consumer.queue-url", () -> queueUrl);
        registry.add("filajusta.matching.liberacao-agendada-consumer.dlq-url", () -> dlqUrl);
        registry.add("filajusta.matching.liberacao-agendada-consumer.poll-interval-ms", () -> "300");
        registry.add("filajusta.matching.liberacao-agendada-consumer.batch-size", () -> "10");
