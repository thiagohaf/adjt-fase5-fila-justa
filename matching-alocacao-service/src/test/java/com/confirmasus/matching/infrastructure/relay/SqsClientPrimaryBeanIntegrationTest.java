 ...
 * com os DOIS relays de SQS ({@code confirmasus.matching.relay} -- Story 3.1b
 * -- e {@code confirmasus.matching.liberacao-agendada-relay} -- Story 3-4a2)
...
class SqsClientPrimaryBeanIntegrationTest {
    ...
    static void relayProperties(DynamicPropertyRegistry registry) {
        // confirmasus.matching.relay.enabled NAO e setado aqui de proposito --
        ...
        registry.add("confirmasus.matching.relay.endpoint-override", () -> "http://localhost:1");
        registry.add("confirmasus.matching.relay.queue-url", () -> "http://localhost:1/000000000000/fake-score");
        ...
        registry.add("confirmasus.matching.liberacao-agendada-relay.endpoint-override", () -> "http://localhost:1");
        registry.add("confirmasus.matching.liberacao-agendada-relay.queue-url",
