...
class LiberacaoAgendadaConsumerSqsClientConfig {
    ...
    SqsClient liberacaoAgendadaSqsClient(
            @Value("${filajusta.matching.liberacao-agendada-consumer.endpoint-override:}") String endpointOverride,
            @Value("${filajusta.matching.liberacao-agendada-consumer.region:}") String region) {
