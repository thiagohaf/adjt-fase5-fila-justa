 ...
 * {@link com.confirmasus.matching.application.command.AtualizarScoreReplica}
 ...
 * {@link com.confirmasus.matching.application.command.ScoreReplicaRepositorio}
 * também vive aqui, implementada em {@code infrastructure/persistence}.
 *
 * <p>{@code application.command} (Story 3.2b2):
 * {@link com.confirmasus.matching.application.command.UpsertRecurso} faz o
 ...
 * {@link com.confirmasus.matching.application.query.ConsultarFilaPriorizada}
 * atende {@code GET /v1/fila} -- réplica vazia dispara o bootstrap síncrono
 * a frio ({@link com.confirmasus.matching.application.query.ScoreBootstrap},
 * implementado em {@code infrastructure/bootstrap} reaproveitando
 * {@code AtualizarScoreReplica}) antes de ler via
 * {@link com.confirmasus.matching.application.query.FilaRepositorio}
 ...
 */
package com.confirmasus.matching.application;
