 ...
 * ({@code confirmasus.matching.liberacao-agendada-relay.enabled}, SEM
 ...
 */
@Component
@ConditionalOnProperty(prefix = "confirmasus.matching.liberacao-agendada-relay", name = "enabled")
class LiberacaoAgendadaRelayJob {
    ...
    LiberacaoAgendadaRelayJob(LiberacaoAgendadaRepositorio liberacaoAgendadaRepositorio,
                               ...
                               @Value("${confirmasus.matching.liberacao-agendada-relay.queue-url}") String queueUrl,
                               @Value("${confirmasus.matching.liberacao-agendada-relay.batch-size:50}") int loteTamanho) {
        ...
        if (queueUrl == null || queueUrl.isBlank()) {
            throw new IllegalStateException("confirmasus.matching.liberacao-agendada-relay.queue-url nao pode ser "
                    + "vazio com confirmasus.matching.liberacao-agendada-relay.enabled=true");
        }
    ...
    @Scheduled(fixedDelayString = "${confirmasus.matching.liberacao-agendada-relay.poll-interval-ms:5000}")
    @Transactional
