 ...
 * {@code confirmasus.matching.relay.endpoint-override} fica vazio -- o SDK
 ...
 * {@code confirmasus.matching.relay.region} (via
 ...
 * {@code confirmasus.matching.relay.enabled}, default {@code true}): usado
...
class ScoreCalculadoSqsClientConfig {
    ...
    @Primary
    @Bean
    SqsClient sqsClient(@Value("${confirmasus.matching.relay.endpoint-override:}") String endpointOverride,
                         @Value("${confirmasus.matching.relay.region:}") String region) {
