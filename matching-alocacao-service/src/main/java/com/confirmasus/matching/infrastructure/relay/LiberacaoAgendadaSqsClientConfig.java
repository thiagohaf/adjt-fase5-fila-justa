 ...
 * ({@code confirmasus.matching.liberacao-agendada-relay.*}, nunca
 * {@code confirmasus.matching.relay.*} nem {@code outbox-relay.*} -- Boundaries
 ...
 * {@code confirmasus.matching.liberacao-agendada-relay.region} (via
...
class LiberacaoAgendadaSqsClientConfig {
    ...
    SqsClient liberacaoAgendadaSqsClient(
            @Value("${confirmasus.matching.liberacao-agendada-relay.endpoint-override:}") String endpointOverride,
            @Value("${confirmasus.matching.liberacao-agendada-relay.region:}") String region) {
