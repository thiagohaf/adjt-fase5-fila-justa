...
import com.confirmasus.matching.application.query.ConsultarFilaPriorizada;
import com.confirmasus.matching.application.query.ConsultarSugestaoRecurso;
import com.confirmasus.matching.application.query.FilaRepositorio;
import com.confirmasus.matching.application.query.RecursoConsultaRepositorio;
import com.confirmasus.matching.application.query.ScoreBootstrap;
import com.confirmasus.matching.application.query.SugestaoRecusadaConsultaRepositorio;
import com.confirmasus.matching.domain.PrioridadeEfetiva;
 ...
 * {@code confirmasus.aging.k}/{@code confirmasus.aging.teto} (application.yml)
 ...
 * partir de {@code confirmasus.liberacao.duracao.rank-{1..4}}
...
public class MatchingAlocacaoServiceApplication {
    ...
    @Bean
    PrioridadeEfetiva prioridadeEfetiva(@Value("${confirmasus.aging.k}") double k,
                                         @Value("${confirmasus.aging.teto}") double teto) {
