...
public class ConsultarAuditoriaPaciente {
    ...
    public DecisaoAuditoriaRepositorio.PaginatedResult<DecisaoAuditoria> consultarComFiltrosEStatusAgendamento(
        ...
        try {
            ...
            // Delega ao repositório com filtros
            DecisaoAuditoriaRepositorio.PaginatedResult<DecisaoAuditoria> resultado =
                    decisaoAuditoriaRepositorio.findByPacienteIdWithFiltersAndStatusAgendamento(
                            pacienteId, startDate, endDate, tipoDecisao, statusAgendamento, limit, offset
                    );
    ...
    /**
     * Consulta com filtros opcionais, incluindo status de agendamento e tipo de paciente, e paginação (Story 4.4b).
     *
     * <p>Propaga {@code X-Correlation-Id} ao MDC para structured logging conforme NFR-2.
     *
     * <p>Filtros são compostos com AND logic: todos os critérios fornecidos devem ser satisfeitos.
     ...
     */
    @Transactional(readOnly = true)
    public DecisaoAuditoriaRepositorio.PaginatedResult<DecisaoAuditoria> consultarComFiltrosEStatusAgendamentoETipoPaciente(
            Long pacienteId,
            Instant startDate,
            Instant endDate,
            TipoDecisao tipoDecisao,
        ...
        try {
            ...
            // Delega ao repositório com filtros
            DecisaoAuditoriaRepositorio.PaginatedResult<DecisaoAuditoria> resultado =
                    decisaoAuditoriaRepositorio.findByPacienteIdWithFiltersAndStatusAgendamentoAndTipoPaciente(
                            pacienteId, startDate, endDate, tipoDecisao, statusAgendamento, tipoPaciente, limit, offset
                    );
