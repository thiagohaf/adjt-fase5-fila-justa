...
/**
 * DTO de entrada com filtros opcionais para consultas de auditoria (Story 4.3).
 *
...
record AuditoriaFiltrosRequest(
    ...
    public static AuditoriaFiltrosRequest of(Instant startDate,
        ...
        return new AuditoriaFiltrosRequest(startDate, endDate, tipoDecisao, limit, offset);
    }
}
